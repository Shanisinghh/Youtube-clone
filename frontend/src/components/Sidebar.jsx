...
function Sidebar() {
  ...
  return (
    ...
    >
      {/* Home */}
      <Link to="/">
        <div className="flex items-center space-x-6 hover:bg-gray-300 duration-300 rounded-xl px-2.5 py-1.5 my-3">
      ...
      <div className=" space-y-2 items-center">
        {sidebarItems.map((item) => {
          return (
            <div
              key={item.id}
              className="flex items-center space-x-6 hover:bg-gray-300 duration-300 rounded-xl px-2.5 py-1.5"
            >
      ...
      <br />
      <p className="text-xs text-gray-500 mb-20 mt-3">
        © 2025 Developed By Shani
      </p>
    </div>
  );
}
